#pragma once
#ifndef TRINITY_DIVIDE_H
#define TRINITY_DIVIDE_H

#include "../ndarray/matrix.h"

template <typename DType, size_t... NShape>
Matrix<DType, NShape...> divide(const Matrix<DType, NShape...>& matrix_1,
...
template <typename DType, size_t... NShape>
Matrix<DType, NShape...> divide(const Matrix<DType, NShape...>& matrix_input,
                                DType scalar) {
