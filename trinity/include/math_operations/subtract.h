#pragma once
#ifndef TRINITY_SUBTRACT_H
#define TRINITY_SUBTRACT_H

#include "../ndarray/matrix.h"

template <typename DType, size_t... NShape>
Matrix<DType, NShape...> subtract(const Matrix<DType, NShape...>& matrix_1,
...
template <typename DType, size_t... NShape>
Matrix<DType, NShape...> subtract(const Matrix<DType, NShape...>& matrix_input,
                                  DType scalar) {
